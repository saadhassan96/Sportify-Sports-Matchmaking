...
class LogIn extends Component{4
  ...
  render() {
    clickOnLogIn = () => {
      let email = this.state.campusID + '@lums.edu.pk'
...
clickOnLogIn = () => {
 ...
 firebase.auth().signInWithEmailAndPassword(this.state.campusID + '@lums.edu.pk', this.state.password).catch( (err) => {console.warn(error.message)})
