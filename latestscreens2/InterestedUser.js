...
class InterestedUser extends Component{
  ...
  render() {
    ...
    clickOnPlayWith = () => {
      ...
      firebaseConf.database().ref('matches/').set({
          sender: rollNum,
          ...
          <RadioGroup
            ...
            {interestedusers.map(buttoninfo => (
                <RadioButton value={buttoninfo[2]} >
                  <Button titleStyle={{color: "#000000"}} buttonStyle={{backgroundColor : "transparent", height: 10}} title={buttoninfo[0]}/>
                  <Button titleStyle={{color: "#000000"}} buttonStyle={{backgroundColor : "transparent", height: 10}} title={buttoninfo[1]}/>
