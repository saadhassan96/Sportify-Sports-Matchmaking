...
class ChangeStatus extends Component<Props>{
  ...
  render() {
    ...
    // console.log("the id is", params.campusID)
      ...
      firebaseConf.database().ref().child('users').child(rollNum).update({available: this.state.availability})
  		this.props.navigation.navigate('homePage', {campusID: params.campusID})
  	}
